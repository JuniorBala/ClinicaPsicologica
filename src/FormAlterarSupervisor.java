...
public class FormAlterarSupervisor extends javax.swing.JFrame {
    String nomeStatic = null;
    String drtStatic = null;
    /**
     * Creates new form FormAlterarSupervisor
     */
    public FormAlterarSupervisor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnAtualizarSupervisor = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Alterar Supervisor");
        setResizable(false);
        ...
        btnAtualizarSupervisor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Knob Refresh.png"))); // NOI18N
        btnAtualizarSupervisor.setText("Atualizar Campos");
        btnAtualizarSupervisor.setToolTipText("Atualizar Campos");
        btnAtualizarSupervisor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAtualizarSupervisorActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(130, 130, 130)
                .addComponent(btnAtualizarSupervisor)
    ...
    private void btnAtualizarSupervisorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarSupervisorActionPerformed
        ...
        if (txt1.isEmpty()) {
            ...
            try {
                ...
                String comando = null;
                if (nomeStatic == null) {
                    comando = "UPDATE Supervisor SET NomeSupervisor = '" + nome + "', DRT = '" + drt + "', Endereco = '" + endereco + "', CEP = " + cep + ", Telefone = '" + telefone + "' WHERE DRT = '" + drtStatic + "';";
                } else if (drtStatic == null) {
                    comando = "UPDATE Supervisor SET NomeSupervisor = '" + nome + "', DRT = '" + drt + "', Endereco = '" + endereco + "', CEP = " + cep + ", Telefone = '" + telefone + "' WHERE NomeSupervisor = '" + nomeStatic + "';";
                }
                ...
                st.execute(comando);
                JOptionPane.showMessageDialog(null, "Supervisor ALTERADO com sucesso !");
    ...
    }//GEN-LAST:event_btnAtualizarSupervisorActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAlterarSupervisor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAlterarSupervisor().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnAtualizarSupervisor;
