...
public class FormProcurarClinica_Alterar extends javax.swing.JFrame {
    static String retornoNome = null;
    static String retornoCNPJ = null;
    /**
     * Creates new form FormProcurarClinica_Alterar
     */
    public FormProcurarClinica_Alterar() {
        initComponents();
    }
    ...
    private void btnProcurarClinicaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarClinicaActionPerformed
        ...
        if (rbNome.isSelected() && txt1.isEmpty()) {
            ...
            txtNomeClinica.setText("");
            txtCNPJ.setText("");
            FormAlterarClinica alterarClinica = new FormAlterarClinica();
            alterarClinica.setLocationRelativeTo(null);
            alterarClinica.setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormProcurarClinica_Alterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormProcurarClinica_Alterar().setVisible(true);
            }
        });
    }
