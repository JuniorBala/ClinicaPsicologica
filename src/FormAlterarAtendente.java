...
public class FormAlterarAtendente extends javax.swing.JFrame {
    static int idSupervisor;
    String nomeStatic = null;
    String tiaStatic = null;
    /**
     * Creates new form FormAlterarAtendente
     */
    public FormAlterarAtendente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnAtualizarAtendente = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Atualizar Atendente");
        setResizable(false);
        ...
        btnAtualizarAtendente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Knob Refresh.png"))); // NOI18N
        btnAtualizarAtendente.setText("Atualizar Campos");
        btnAtualizarAtendente.setToolTipText("Atualizar Campos");
        btnAtualizarAtendente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAtualizarAtendenteActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(134, 134, 134)
                .addComponent(btnAtualizarAtendente)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnAtualizarAtendenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarAtendenteActionPerformed
        ...
        if (txt1.isEmpty()) {
            ...
            try {
                ...
                String comando = null;
                if (nomeStatic == null) {
                    comando = "UPDATE Atendente SET NomeAtendente = '" + nome + "', TIA = '" + tia + "', Endereco = '" + endereco + "', CEP = " + cep + ", Telefone = '" + telefone + "' WHERE TIA = '" + tiaStatic + "';";
                } else if (tiaStatic == null) {
                    comando = "UPDATE Atendente SET NomeAtendente = '" + nome + "', TIA = '" + tia + "', Endereco = '" + endereco + "', CEP = " + cep + ", Telefone = '" + telefone + "' WHERE NomeAtendente = '" + nomeStatic + "';";
                }
    ...
    }//GEN-LAST:event_btnAtualizarAtendenteActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAlterarAtendente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAlterarAtendente().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnAtualizarAtendente;
