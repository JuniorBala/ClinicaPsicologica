...
public class FormConsultarAtendente extends javax.swing.JFrame {
    static int idSupervisor;
    /**
     * Creates new form FormConsultarAtendente
     */
    public FormConsultarAtendente() {
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            while (rp.next()) {
                nomeSupervisor = rp.getString("NomeSupervisor");            
                txtSupervisor.setText(nomeSupervisor);
            }
            if(nomeSupervisor == null){
                txtSupervisor.setText("NÃO TEM");
            }
            //fecha a conexão
            st.close();
            c.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormConsultarAtendente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormConsultarAtendente().setVisible(true);
            }
        });
    }
