...
public class FormConsultarDiagnostico extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FormConsultarDiagnostico
     */
    public FormConsultarDiagnostico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Consultar Diagnóstico");
        setResizable(false);
        ...
        btnFechar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mult.png"))); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        FormProcurarPaciente_ConsultarDiagnostico consultarPaciente = new FormProcurarPaciente_ConsultarDiagnostico();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormConsultarDiagnostico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormConsultarDiagnostico().setVisible(true);
            }
        });
    }
