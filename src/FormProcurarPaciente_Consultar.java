...
public class FormProcurarPaciente_Consultar extends javax.swing.JFrame {
    static String retornoRG = null;
    static String retornoCPF = null;
    /**
     * Creates new form FormProcurarPaciente_Consultar
     */
    public FormProcurarPaciente_Consultar() {
        initComponents();
    }
    ...
    private void btnProcurarPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarPacienteActionPerformed
        ...
        if (rbRG.isSelected() && txt1.isEmpty()) {
            ...
            txtRG.setText("");
            txtCPF.setText("");
            FormConsultarPaciente consultarPaciente = new FormConsultarPaciente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormProcurarPaciente_Consultar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormProcurarPaciente_Consultar().setVisible(true);
            }
        });
    }
