...
public class FormProcurarPaciente_Alterar extends javax.swing.JFrame {
    static String retornoRG = null;
    static String retornoCPF = null;
    /**
     * Creates new form FormProcurarPaciente_Alterar
     */
    public FormProcurarPaciente_Alterar() {
        initComponents();
    }
    ...
    private void btnProcurarPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarPacienteActionPerformed
        ...
        if (rbRG.isSelected() && txt1.isEmpty()) {
            ...
            txtRG.setText("");
            txtCPF.setText("");
            FormAlterarPaciente alterarPaciente = new FormAlterarPaciente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormProcurarPaciente_Alterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormProcurarPaciente_Alterar().setVisible(true);
            }
        });
    }
