...
public class FormProcurarPaciente_Diagnostico extends javax.swing.JFrame {
    static String retornoRG = null;
    static String retornoCPF = null;
    /**
     * Creates new form FormProcurarPaciente_Diagnostico
     */
    public FormProcurarPaciente_Diagnostico() {
        initComponents();
    }
    ...
    private void btnProcurarPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarPacienteActionPerformed
        ...
        if (rbRG.isSelected() && txt1.isEmpty()) {
            ...
            txtRG.setText("");
            txtCPF.setText("");
            FormRealizarDiagnostico realizarDiagnostico = new FormRealizarDiagnostico();
            realizarDiagnostico.setLocationRelativeTo(null);
            realizarDiagnostico.setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormProcurarPaciente_Diagnostico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormProcurarPaciente_Diagnostico().setVisible(true);
            }
        });
    }
