...
public class FormProcurarAtendente_Excluir extends javax.swing.JFrame {
    static String retornoNome = null;
    static String retornoTIA = null;
    /**
     * Creates new form FormProcurarAtendente_Excluir
     */
    public FormProcurarAtendente_Excluir() {
        initComponents();
    }
    ...
    private void btnProcurarAtendenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarAtendenteActionPerformed
        ...
        if (rbNome.isSelected() && txt1.isEmpty()) {
            ...
            txtNomeAtendente.setText("");
            txtTIA.setText("");
            FormExcluirAtendente excluirAtendente = new FormExcluirAtendente();
            excluirAtendente.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormProcurarAtendente_Excluir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormProcurarAtendente_Excluir().setVisible(true);
            }
        });
    }
