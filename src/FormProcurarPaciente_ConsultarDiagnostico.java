...
public class FormProcurarPaciente_ConsultarDiagnostico extends javax.swing.JFrame {
    static String retornoRG = null;
    static String retornoCPF = null;
    /**
     * Creates new form FormProcurarPaciente_ConsultarDiagnostico
     */
    public FormProcurarPaciente_ConsultarDiagnostico() {
        initComponents();
    }
    ...
    private void btnProcurarPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarPacienteActionPerformed
        ...
        if (rbRG.isSelected() && txt1.isEmpty()) {
            ...
            txtRG.setText("");
            txtCPF.setText("");
            FormConsultarDiagnostico consultarDiagnostico = new FormConsultarDiagnostico();
            consultarDiagnostico.setLocationRelativeTo(null);
            consultarDiagnostico.setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormProcurarPaciente_ConsultarDiagnostico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormProcurarPaciente_ConsultarDiagnostico().setVisible(true);
            }
        });
    }
