...
public class FormProcurarPaciente_Agenda_Excluir extends javax.swing.JFrame {
    static String retornoRG = null;
    static String retornoCPF = null;
    static String retornoExame = null;
    int idE;
    /**
     * Creates new form FormProcurarPaciente_Agenda_Excluir
     */
    public FormProcurarPaciente_Agenda_Excluir() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        labExame.setText("Exames:");
        labExame.setToolTipText("");
            ...
            .add(painel1Layout.createSequentialGroup()
                ...
                .add(painel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(painel1Layout.createSequentialGroup()
                        .add(labExame)
                        .add(18, 18, 18)
                        .add(comboExames, 0, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .add(painel1Layout.createSequentialGroup()
                        .add(labRG)
                    ...
                    .add(rbRG))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                .add(painel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(painel1Layout.createSequentialGroup()
                        .add(labCPF)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                        .add(txtCPF, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE))
                    .add(painel1Layout.createSequentialGroup()
                        .add(rbCPF)
    ...
    private void btnProcurarPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarPacienteActionPerformed
        ...
        if (rbRG.isSelected() && txt1.isEmpty()) {
            ...
            txtRG.setText("");
            txtCPF.setText("");
            FormExcluirAgenda excluirAgenda = new FormExcluirAgenda();
            excluirAgenda.setLocationRelativeTo(null);
            excluirAgenda.setVisible(true);
            this.dispose();
            retornoExame = (String) comboExames.getSelectedItem();
            //JOptionPane.showMessageDialog(null, retornoExame);
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            ResultSet rp = st.executeQuery("SELECT * FROM ListaExame ORDER BY NomeExame;");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormProcurarPaciente_Agenda_Excluir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormProcurarPaciente_Agenda_Excluir().setVisible(true);
            }
        });
    }
